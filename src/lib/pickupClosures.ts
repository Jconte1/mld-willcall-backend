const ALL_LOCATION_HOLIDAYS = new Set<string>([
...
const LOCATION_HOLIDAYS: Record<string, Set<string>> = {
...
export function isHolidayClosure(dateStr: string, locationId: string | null | undefined): boolean {
  if (ALL_LOCATION_HOLIDAYS.has(dateStr)) return true;
