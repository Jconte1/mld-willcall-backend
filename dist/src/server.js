...
const staffProfile_1 = require("./routes/staffProfile");
...
const internalInvites_1 = require("./routes/internalInvites");
...
// Staff profile
app.use("/api/staff/profile", staffProfile_1.staffProfileRouter);
// Customer auth
...
app.use("/api/internal/invites", internalInvites_1.internalInvitesRouter);
...
app.use("/api/twilio", twilioInbound_1.twilioInboundRouter);
