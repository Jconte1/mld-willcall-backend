...
exports.ingestInventoryDetails = ingestInventoryDetails;
...
async function handleOne(restService, baid) {
    ...
    const tF1 = nowMs();
    try {
        rows = await (0, fetchInventoryDetails_1.default)(restService, baid, orderNbrs, {
    ...
    const tW1 = nowMs();
    const result = await (0, writeInventoryDetails_1.default)(baid, rows, { chunkSize: 5000 });
    const tW2 = nowMs();
    return {
        baid,
...
async function ingestInventoryDetails(baid) {
