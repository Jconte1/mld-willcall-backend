...
async function tick() {
    try {
        await (0, runOrderReadySync_1.runOrderReadySync)(prisma_1.prisma);
        await (0, runOrderReadyEscalations_1.runOrderReadyEscalations)(prisma_1.prisma);
        await (0, runNoShowSweep_1.runNoShowSweep)(prisma_1.prisma);
        await (0, runPendingJobs_1.runPendingJobs)(prisma_1.prisma);
    }
    catch (err) {
